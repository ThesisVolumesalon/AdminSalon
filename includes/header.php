      ...
      <div class="header-right">
        <div class="profile_details_left"><!--notifications of menu start -->
          <ul class="nofitications-dropdown">
            <?php
$ret1=mysqli_query($con,"select userid from  tblappointment where Status=''");
...
{
            ?>
                 <a class="dropdown-item" href="view-appointment.php?viewid=<?php echo $result['userid'];?>">New appointment received from <?php  
                    $uid = $result['userid'];
                    $ret2=mysqli_query($con,"select userfirstname from  tblusers where user_id= $uid ");
                    $num1=mysqli_num_rows($ret2);
                if($num1){
                    while($result2=mysqli_fetch_array($ret2)) {
                     echo $result2['userfirstname'];  } 
                   } ?> </a><br />
<?php }} else {?>
