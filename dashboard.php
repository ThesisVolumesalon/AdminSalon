...
<html>
<head>
<title>VOLUME SALON | Admin Dashboard</title>
			...
			<div class="main-page">
				...
				<div class="row calender widget-shadow">
					...
					<div class="col-md-4 widget ">
						<?php $query2=mysqli_query($con,"select AptNumber
 from tblappointment 
   where date(AptDate)=CURDATE() and Status = 1;");
$totalappointment=mysqli_num_rows($query2);
?>					<a href="today-appointment.php">
...
?>
						...
						<div class="clearfix"> </div>	
					</div><div class="col-md-4 widget states-last">
