        ...
        <button class="btn bckclrred" align="Left" ><a href="rejected-appointment.php"> REJECT APPOINTMENT</a></button>
			...
			<?php $sql = "SELECT 
                    ...
                    from 	
						...
						tblappointment ap 
					where 
						U.user_id =  ap.userid   order by Status =1 and AptDate DESC";
...
<?php }else if($row['Status'] == "1"){ ?>
		<td style="color: green;">ACCEPT</td><?php 
}else{ ?>
						 	<td><a href="view-appointment.php?viewid=<?php echo $row['user_id'];?>">View</a></td> <?php } ?>
