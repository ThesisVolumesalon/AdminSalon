			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						<h3 class="title1">ALL REJECTED APPOINTMENT</h3>
						

            <button class="btn" style="font-size:16px; color:red" align="Left" ><a href="all-appointment.php"> ALL APPOINTMENT</a></button>
            <button class="btn bckclrgreen" style="font-size:16px; color:red" align="Left" ><a href="accepted-appointment.php"> ACCEPT APPOINTMENT</a></button>
            <button class="btn bckclrred" style="font-size:16px; color:red" align="Left" ><a href="rejected-appointment.php"> REJECT APPOINTMENT</a></button>
...
$sql = "SELECT
                    ...
                    from 	
						...
						tblappointment ap 
					where 
						U.user_id =  ap.userid and Status =2   order by AptDate, AptTime DESC";
