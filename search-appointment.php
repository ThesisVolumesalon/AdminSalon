...
$sql = "SELECT 
                    ...
                    from 	
						...
						tblappointment ap 
					where 
						U.user_id = ap.userid and AptNumber like '%$sdata%' || userfirstname like '%$sdata%' || userphonenumber like '%$sdata%' ";
...
?>
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['AptNumber'];?></td> <td><?php  echo $row['FULLNAME'];?></td><td><?php  echo $row['userphonenumber'];?></td><td><?php  echo $row['AptDate'];?></td> <td><?php  echo $row['AptTime'];?></td> <td><a href="view-appointment.php?viewid=<?php echo $row['user_id'];?>">View</a></td> </tr>   <?php 
$cnt=$cnt+1;
} } else { ?>
  <tr>
